...
const MobileNavigation = ({ownerId, accountId, fullName, avatar, email}: Props) => {
  ...
  return (
    <header className='mobile-header'>
      <Image src="/assets/icons/logo-full-brand.svg" height={52} width={120} alt='logo' className='h-auto'/>
        ...
        <SheetContent className='shad-sheet h-screen px-3'>
            <SheetTitle>
              <div className='header-user'>
                <Image src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png" alt='avatar' width={44} height={44} className='header-user-avatar'/>
